...
export default defineConfig({
  ...
  resolve: {
    ...
    // its imports could resolve to nested copies, breaking singleton identity
    // (EPackageRegistry.INSTANCE, eClass identity, provide/inject).
  ...
  optimizeDeps: {
    ...
    // @emfts/uimodel-composer must stay out of the pre-bundle too, so its
    // @emfts/core imports stay deduped onto the app instance.
