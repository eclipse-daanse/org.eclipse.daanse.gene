 ...
 * @generated
 */
export class KeyValueImpl extends BasicEObject implements KeyValue {
  ...
  override eClass(): EClass {
    return FennecuiPackage.Literals.KEY_VALUE;
  }
  ...
  set key(value: string) {
    ...
    if (this.eDeliver()) {
      this.eNotify({
        getNotifier: () => this,
        getEventType: () => 1, // SET
        getFeature: () => this.eClass().getEStructuralFeature(KeyValueImpl.KEY),
  ...
  set value(value: string) {
    ...
    if (this.eDeliver()) {
      this.eNotify({
        getNotifier: () => this,
        getEventType: () => 1, // SET
        getFeature: () => this.eClass().getEStructuralFeature(KeyValueImpl.VALUE),
        getOldValue: () => oldValue,
        getNewValue: () => value,
        getPosition: () => -1,
        wasSet: () => true,
        isTouch: () => false,
        isReset: () => false,
        getFeatureID: () => KeyValueImpl.VALUE,
        merge: () => false
      });
    }
  }
  ...
  override eGet(feature: EStructuralFeature): unknown {
    ...
    switch (featureID) {
      case KeyValueImpl.KEY:
        return this.key;
      case KeyValueImpl.VALUE:
        return this.value;
      default:
